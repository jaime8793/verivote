...
const Elections = () => {
  return (
    <>
      <main className="w-full text-gray-900 font-[Helvetica] px-4 py-4 max-w-md md:max-w-3xl lg:max-w-5xl mx-auto">
        {/* Breadcrumb */}
        ...
        <p className="text-sm md:text-base font-bold mb-4 leading-snug">
          Find information about upcoming elections, including key dates and
          positions up for election.
        </p>

        {/* Election Info */}
        <div className="bg-[#43761E] text-white text-sm md:text-base font-bold px-4 py-2 rounded w-fit mb-4">
          General Elections
        ...
        {/* Deadline */}
        <div className="text-xs md:text-sm font-bold mt-1 mb-6">
        ...
        {/* Link */}
        <p className="text-xs md:text-sm mt-10 mb-20 font-bold">
          View our{" "}
        ...
        {/* Campaign Trail */}
        <h2 className="text-lg md:text-xl font-extrabold mt-8 mb-4">
        ...
        <div className="relative mb-2">
          <img
            ...
            className="rounded w-full"
          />
          <div className="absolute bottom-2 left-2 bg-black bg-opacity-50 text-white px-2 py-1 text-xs md:text-sm font-semibold rounded">
            Jane Doe Campaign
          </div>
        </div>
        ...
        <div className="mt-4 text-sm leading-snug mb-2">
          ...
          <p className="text-xs md:text-sm italic text-red-600 mt-10 underline">
            Watch Interview on Healthcare Policy
          </p>
          <p className="text-xs md:text-sm italic text-red-600 mb-10 underline">
