  ...
  return (
    <div className=" bg-white text-black font-sans">
        ...
        <div className="lg:flex lg:justify-center lg:gap-8 xl:gap-12 lg:max-w-6xl lg:mx-auto lg:space-y-0 space-y-6">
          <div className="lg:flex-1 lg:max-w-xs">
            ...
            <img
              src="/icons/check.svg"
              alt="Check icon"
              className="mx-auto mb-2 w-10 h-10 lg:w-12 lg:h-12 xl:w-14 xl:h-14"
            />
      ...
      <section className="px-6 py-8 text-center lg:px-12 lg:py-12 xl:px-16">
        ...
        <button className="bg-[#0077CC] mb-16 mt-8 w-80 text-[1rem] italic text-white px-6 py-2 rounded-full text-sm font-semibold hover:bg-blue-700 lg:w-96 lg:text-lg lg:py-3 xl:w-[28rem] xl:text-xl xl:py-4 transition-colors">
